...
test('Validar que una funcion NO nos regrese la cadena Adios Amigo', () =>{
...
test('Validar que una funcion nos regrese una cadena que no contenga la palabra Aloha', () =>{
    expect(operaciones.holaMundo()).not.toContain('Aloha')
});
...
test('Validar que una funcion NO regresa el match de la variable', () =>{
    let alo = 'alo'
...
test('Validar que una funcion que nos regresa un numero de caracteres', () =>{
...
test('Validar que la funcion que suma 2 mas 2 NO regresa el valor de 7', () =>{
...
test('Validar que la funcion que suma 2 mas 2 No regresa una cadena', () =>{
...
test('Validar que la funcion no acepta caracter especial & dentro de la cadena', () => {
    expect(operaciones.minusculas('ar&3ew')).toBe('Solo se aceptan letras')
})